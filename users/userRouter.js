...
router.post('/', validateUser, (req, res) => {
  ...
  userdb
    ...
    .catch(err => {
      ...
      res
        .status(500)
        .json({ errmessage: 'There was an error creating a user.' });
    });
});
...
router.post('/:id/posts', validatePost, (req, res) => {
  ...
  postdb
    ...
    .catch(err => {
      ...
      res
        .status(500)
        .json({ errmessage: 'There was an error creating a post.' });
    });
});
...
router.delete('/:id', (req, res) => {
  ...
  userdb
    ...
    .then(user => res.status(200).json({ message: `User has been deleted` }))
    .catch(err => {
